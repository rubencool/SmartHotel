            ...
            <ul class="list-unstyled team-members">
              <li>
                <div class="row" v-for="section in sectionList">
                  ...
                  <a :href="'http://localhost:8080/#/admin/section/edit/' +section.id"><i id="icon" class="material-icons">update</i></a>
                  </div>
    ...
    methods: {
      ...
      dlt: function (id) {
        ...
        if (this.sectionTableList === []) {
          axios.delete('http://localhost:8000/api/food/section/' + id + "/delete/")
            .then(response => {
            }).catch(e => {
            this.errors.push(e)
            console.error(e)
          ...
          this.error = "Cant delete section contain table"
        }
      }
    }
  }
