      ...
      getInServiceTable: function () {
        axios.get('http://localhost:8000/api/food/table/registered')
          .then(response => {
            ...
            this.statsCards[0].value = response.data.length
          }).catch(e => {
          this.errors.push(e)
          console.error(e)
        })
      ...
      getUnServiceTable: function () {
        axios.get('http://localhost:8000/api/food/table/unregistered')
          .then(response => {
            ...
            this.statsCards[1].value = response.data.length
          }).catch(e => {
          this.errors.push(e)
          console.error(e)
        })
      },
      getTotalTable: function () {
        axios.get('http://localhost:8000/api/food/table')
          .then(response => {
            console.log(response.data)
            this.statsCards[2].value = response.data.length
            this.statsCards[3].value += response.data.length * 4
          }).catch(e => {
          this.errors.push(e)
          console.error(e)
        })
